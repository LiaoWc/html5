    ...
    this.registerSystem.push({
        ...
        onInit: function () {
            ...
            this.renderEntity = function (aEntity, aCanvas) {
                ...
                if (comChildren) {
                    if (aEntity.components.render.property.canvas == null) {
                        if (aEntity.components.render.property.drawCall) {
                            aEntity.components.render.property.drawCall(aCanvas);
                        }
                    }
