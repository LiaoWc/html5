...
app.works = function () {
    ...
    var root = function () {
        ...
        sysEvent.listen(entity, "rootSceneResize", function (aEvent) {
            ...
            node.update();
            sysEvent.dispatch(entity, "worksResize", {
    ...
    var tips = function () {
        ...
        //处理尺寸变化
        var event = entity.addComponent("event");
        sysEvent.listen(entity, "worksResize", function (aEvent) {
    ...
    var createItem = function (args) {
        ...
        var qrcodeImage = function () {
            ...
            entity.addComponent("children");
            var image = entity.addComponent("domImage");
            image.property.file = "assets/qr" + (number + 1) + ".png";
            image.update();
            ...
            //处理尺寸变化
            var event = entity.addComponent("event");
            sysEvent.listen(entity, "worksEnabled", function () {
                if (root.enabled == false) {
                    image.property.element.style.visibility = "hidden";
                } else {
                    image.property.element.style.visibility = "visible";
                }
            })
            sysEvent.listen(entity, "worksResize", function (aEvent) {
        ...
        var nameText = function () {
            ...
            sysEvent.listen(entity, "worksResize", function (aEvent) {
                ...
                var fontSize = Math.min(aEvent.width / 20, aEvent.height / 40)
